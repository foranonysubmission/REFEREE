...
Usage: We have three datasets for experiments. To choose the dataset, change the variable named prog_args.dataset in train.py. Then run the following command to train the GNN to be explained:
